...
The package was written generally, such that any regression model should be compatible.  However, only `survival::coxph()`, and `survival::survreg()`, `lm()`, and `glm()` models were tested.
