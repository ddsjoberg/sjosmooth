...
![simplystatistics.org. loess explained in a GIF](https://raw.githubusercontent.com/simplystats/simplystats.github.io/master/_images/loess.gif)
...
The `sjosmooth` package currently supports four kernels: Epanechnikov, Tri-cube, Gaussian, and k-nearest neighbor. The kernel specifies how much weight is given to each observation in your dataset when performing the weighted regression.  The figure below illustrates three kernels.
